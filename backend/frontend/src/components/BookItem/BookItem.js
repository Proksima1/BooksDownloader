...
// 		super(props);
// 		this.state = {
// 			'downloadUrl': props.book.downloadUrl,
// 		}
...
// 			<div className="book-item">
// 				<div className="book-item__about">
// 					<img src={this.props.book?.cover} alt="Book cover" className="book-item__cover" />
// 					<div className="book-item__desc-block">
// 						<h1 className="book-item__title">{this.props.book?.title}</h1>
// 						<p className="book-item__author">{this.props.book?.author}</p>
// 						<i className="book-item__source">Источник: {this.props.book?.source}</i>
// 					</div>
// 				</div>
// 				<a onClick={this.parseBook} className="book-item__download">
// 					<img src={logo} alt="Download icon" />
// 				</a>
// 			</div >
// 		)
